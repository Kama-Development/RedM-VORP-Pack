...
-- Databasestructuur van vorp-pack wordt geschreven
CREATE DATABASE IF NOT EXISTS `vorp-pack` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `vorp-pack`;

-- Structuur van  tabel vorp-pack.banks wordt geschreven
CREATE TABLE IF NOT EXISTS `banks` (
  `name` varchar(50) NOT NULL,
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumpen data van tabel vorp-pack.banks: ~3 rows (ongeveer)
DELETE FROM `banks`;
...
-- Structuur van  tabel vorp-pack.bank_users wordt geschreven
...
-- Dumpen data van tabel vorp-pack.bank_users: ~0 rows (ongeveer)
DELETE FROM `bank_users`;

-- Structuur van  tabel vorp-pack.banneds wordt geschreven
...
-- Dumpen data van tabel vorp-pack.banneds: ~0 rows (ongeveer)
DELETE FROM `banneds`;

-- Structuur van  tabel vorp-pack.bills wordt geschreven
...
-- Dumpen data van tabel vorp-pack.bills: ~0 rows (ongeveer)
DELETE FROM `bills`;

-- Structuur van  tabel vorp-pack.boates wordt geschreven
...
-- Dumpen data van tabel vorp-pack.boates: ~0 rows (ongeveer)
DELETE FROM `boates`;

-- Structuur van  tabel vorp-pack.bounty wordt geschreven
...
-- Dumpen data van tabel vorp-pack.bounty: ~0 rows (ongeveer)
DELETE FROM `bounty`;

-- Structuur van  tabel vorp-pack.characters wordt geschreven
...
) ENGINE=InnoDB AUTO_INCREMENT=632 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;

-- Dumpen data van tabel vorp-pack.characters: ~1 rows (ongeveer)
...
-- Dumpen data van tabel vorp-pack.container: ~20 rows (ongeveer)
...
-- Structuur van  tabel vorp-pack.dogs wordt geschreven
...
-- Dumpen data van tabel vorp-pack.dogs: ~0 rows (ongeveer)
DELETE FROM `dogs`;

-- Structuur van  tabel vorp-pack.doors wordt geschreven
...
-- Dumpen data van tabel vorp-pack.doors: ~40 rows (ongeveer)
DELETE FROM `doors`;
...
-- Structuur van  tabel vorp-pack.farming wordt geschreven
...
-- Dumpen data van tabel vorp-pack.farming: ~0 rows (ongeveer)
DELETE FROM `farming`;

-- Structuur van  tabel vorp-pack.horses wordt geschreven
...
-- Dumpen data van tabel vorp-pack.horses: ~0 rows (ongeveer)
DELETE FROM `horses`;

-- Structuur van  tabel vorp-pack.horse_complements wordt geschreven
...
-- Dumpen data van tabel vorp-pack.horse_complements: ~0 rows (ongeveer)
DELETE FROM `horse_complements`;

-- Structuur van  tabel vorp-pack.items wordt geschreven
...
-- Dumpen data van tabel vorp-pack.items: ~337 rows (ongeveer)
DELETE FROM `items`;
...
-- Structuur van  tabel vorp-pack.jail wordt geschreven
...
-- Dumpen data van tabel vorp-pack.jail: ~0 rows (ongeveer)
DELETE FROM `jail`;

-- Structuur van  tabel vorp-pack.loadout wordt geschreven
...
-- Dumpen data van tabel vorp-pack.loadout: ~3 rows (ongeveer)
DELETE FROM `loadout`;
INSERT INTO `loadout` (`id`, `identifier`, `charidentifier`, `name`, `ammo`, `components`, `dirtlevel`, `mudlevel`, `conditionlevel`, `rustlevel`, `used`, `used2`, `dropped`, `comps`, `label`) VALUES
	(2280, 'steam:1100001038e0c77', 629, 'WEAPON_MELEE_KNIFE', '[]', '[]', 0, 0, 0, 0, 0, 0, 1, '{}', NULL),
	(2281, 'steam:1100001038e0c77', 630, 'WEAPON_MELEE_KNIFE', '[]', '[]', 0, 0, 0, 0, 0, 0, 0, '{}', NULL),
	(2282, 'steam:1100001038e0c77', 631, 'WEAPON_MELEE_KNIFE', '[]', '[]', 0, 0, 0, 0, 0, 0, 0, '{}', NULL);

-- Structuur van  tabel vorp-pack.logs wordt geschreven
...
-- Dumpen data van tabel vorp-pack.logs: ~0 rows (ongeveer)
DELETE FROM `logs`;

-- Structuur van  tabel vorp-pack.mail wordt geschreven
...
-- Dumpen data van tabel vorp-pack.mail: ~0 rows (ongeveer)
DELETE FROM `mail`;

-- Structuur van  tabel vorp-pack.mail_inbox wordt geschreven
...
-- Dumpen data van tabel vorp-pack.mail_inbox: ~0 rows (ongeveer)
DELETE FROM `mail_inbox`;

-- Structuur van  tabel vorp-pack.market wordt geschreven
...
-- Dumpen data van tabel vorp-pack.market: ~0 rows (ongeveer)
DELETE FROM `market`;

-- Structuur van  tabel vorp-pack.newspaper wordt geschreven
CREATE TABLE IF NOT EXISTS `newspaper` (
  `news` longtext DEFAULT '[]'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumpen data van tabel vorp-pack.newspaper: ~0 rows (ongeveer)
DELETE FROM `newspaper`;
INSERT INTO `newspaper` (`news`) VALUES
	('[]');

-- Structuur van  tabel vorp-pack.outfits wordt geschreven
...
-- Dumpen data van tabel vorp-pack.outfits: ~4 rows (ongeveer)
DELETE FROM `outfits`;
INSERT INTO `outfits` (`id`, `identifier`, `charidentifier`, `title`, `comps`) VALUES
	(1, 'steam:1100001038e0c77', 629, 'Kama', '{"Hat":2617149224,"Mask":4294967295,"EyeWear":710985267,"NeckWear":4294967295,"NeckTies":2608670781,"Shirt":4294967295,"Suspender":4294967295,"Vest":291860984,"Coat":31209824,"Poncho":4294967295,"Cloak":4294967295,"Glove":4294967295,"RingRh":4294967295,"RingLh":4294967295,"Bracelet":4294967295,"Gunbelt":4294967295,"Belt":4294967295,"Buckle":4294967295,"Holster":4294967295,"Pant":2773691551,"Skirt":4294967295,"Chap":4294967295,"Boots":3910092689,"Spurs":4294967295,"Spats":4294967295,"Gauntlets":4294967295,"Loadouts":4294967295,"Accessories":4294967295,"Satchels":4294967295,"GunbeltAccs":4294967295,"CoatClosed":4294967295}'),
	(2, 'steam:1100001038e0c77', 629, '2', '{"Hat":730419117,"Mask":4294967295,"EyeWear":710985267,"NeckWear":4294967295,"NeckTies":2608670781,"Shirt":342833122,"Suspender":4294967295,"Vest":291860984,"Coat":-1,"Poncho":4294967295,"Cloak":4294967295,"Glove":4294967295,"RingRh":4294967295,"RingLh":4294967295,"Bracelet":4294967295,"Gunbelt":4294967295,"Belt":4294967295,"Buckle":4294967295,"Holster":4294967295,"Pant":665531131,"Skirt":4294967295,"Chap":-1,"Boots":3910092689,"Spurs":3314140176,"Spats":-1,"Gauntlets":-1,"Loadouts":4046007197,"Accessories":106536658,"Satchels":3997825462,"GunbeltAccs":271365123,"CoatClosed":-1}'),
	(3, 'steam:1100001038e0c77', 630, 'Kama', '{"Hat":2534606558,"Mask":0,"EyeWear":280793835,"NeckWear":0,"NeckTies":3338155929,"Shirt":35265146,"Suspender":0,"Vest":2935130771,"Coat":154924622,"Poncho":0,"Cloak":0,"Glove":50751097,"RingRh":0,"RingLh":0,"Bracelet":0,"Gunbelt":0,"Belt":0,"Buckle":0,"Holster":0,"Pant":16798151,"Skirt":0,"Chap":0,"Boots":2422768133,"Spurs":0,"Spats":0,"Gauntlets":0,"Loadouts":0,"Accessories":0,"Satchels":0,"GunbeltAccs":0,"CoatClosed":-1,"bow":0,"armor":0,"teeth":0}'),
	(4, 'steam:1100001038e0c77', 630, 'Kama1', '{"Hat":705297589,"Mask":0,"EyeWear":280793835,"NeckWear":0,"NeckTies":3338155929,"Shirt":35265146,"Suspender":0,"Vest":2935130771,"Coat":154924622,"Poncho":0,"Cloak":0,"Glove":50751097,"RingRh":0,"RingLh":0,"Bracelet":0,"Gunbelt":0,"Belt":0,"Buckle":0,"Holster":0,"Pant":16798151,"Skirt":0,"Chap":0,"Boots":2422768133,"Spurs":0,"Spats":0,"Gauntlets":0,"Loadouts":0,"Accessories":0,"Satchels":0,"GunbeltAccs":0,"CoatClosed":4294967295,"bow":0,"armor":0,"teeth":0}'),
	(5, 'steam:1100001038e0c77', 631, '', '{"Hat":3809299796,"Mask":4294967295,"EyeWear":442424923,"NeckWear":4294967295,"NeckTies":4294967295,"Shirt":4294967295,"Suspender":4294967295,"Vest":802862819,"Coat":2441282065,"Poncho":4294967295,"Cloak":4294967295,"Glove":50751097,"RingRh":4294967295,"RingLh":4294967295,"Bracelet":4294967295,"Gunbelt":4294967295,"Belt":4294967295,"Buckle":4294967295,"Holster":4294967295,"Pant":28202123,"Skirt":4294967295,"Chap":4294967295,"Boots":3881975707,"Spurs":4294967295,"Spats":4294967295,"Gauntlets":4294967295,"Loadouts":118271052,"Accessories":4294967295,"Satchels":4294967295,"GunbeltAccs":4294967295,"CoatClosed":4294967295}');

-- Structuur van  tabel vorp-pack.outfitter wordt geschreven
...
-- Dumpen data van tabel vorp-pack.outfitter: ~0 rows (ongeveer)
DELETE FROM `outfitter`;

-- Structuur van  tabel vorp-pack.playerhousing wordt geschreven
...
-- Dumpen data van tabel vorp-pack.playerhousing: ~0 rows (ongeveer)
DELETE FROM `playerhousing`;

-- Structuur van  tabel vorp-pack.playerhousing_sold_home_ledger wordt geschreven
...
-- Dumpen data van tabel vorp-pack.playerhousing_sold_home_ledger: ~0 rows (ongeveer)
DELETE FROM `playerhousing_sold_home_ledger`;

-- Structuur van  tabel vorp-pack.playerscenes wordt geschreven
...
-- Dumpen data van tabel vorp-pack.playerscenes: ~0 rows (ongeveer)
DELETE FROM `playerscenes`;

-- Structuur van  tabel vorp-pack.playershops wordt geschreven
...
-- Dumpen data van tabel vorp-pack.playershops: ~0 rows (ongeveer)
DELETE FROM `playershops`;

-- Structuur van  tabel vorp-pack.player_ranch wordt geschreven
...
-- Dumpen data van tabel vorp-pack.player_ranch: ~0 rows (ongeveer)
DELETE FROM `player_ranch`;

-- Structuur van  tabel vorp-pack.player_trains wordt geschreven
...
-- Dumpen data van tabel vorp-pack.player_trains: ~0 rows (ongeveer)
DELETE FROM `player_trains`;

-- Structuur van  tabel vorp-pack.posters wordt geschreven
...
-- Dumpen data van tabel vorp-pack.posters: ~0 rows (ongeveer)
DELETE FROM `posters`;

-- Structuur van  tabel vorp-pack.races wordt geschreven
...
-- Dumpen data van tabel vorp-pack.races: ~0 rows (ongeveer)
DELETE FROM `races`;

-- Structuur van  tabel vorp-pack.robbery wordt geschreven
...
-- Dumpen data van tabel vorp-pack.robbery: ~0 rows (ongeveer)
DELETE FROM `robbery`;

-- Structuur van  tabel vorp-pack.rooms wordt geschreven
...
-- Dumpen data van tabel vorp-pack.rooms: ~0 rows (ongeveer)
DELETE FROM `rooms`;

-- Structuur van  tabel vorp-pack.society wordt geschreven
...
-- Dumpen data van tabel vorp-pack.society: ~81 rows (ongeveer)
DELETE FROM `society`;
...
-- Structuur van  tabel vorp-pack.society_ledger wordt geschreven
CREATE TABLE IF NOT EXISTS `society_ledger` (
  `job` longtext DEFAULT NULL,
  `ledger` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumpen data van tabel vorp-pack.society_ledger: ~18 rows (ongeveer)
...
-- Structuur van  tabel vorp-pack.society_shops wordt geschreven
...
-- Dumpen data van tabel vorp-pack.society_shops: ~12 rows (ongeveer)
...
-- Structuur van  tabel vorp-pack.stables wordt geschreven
...
-- Dumpen data van tabel vorp-pack.stables: ~0 rows (ongeveer)
DELETE FROM `stables`;

-- Structuur van  tabel vorp-pack.transactions wordt geschreven
...
-- Dumpen data van tabel vorp-pack.transactions: ~0 rows (ongeveer)
DELETE FROM `transactions`;

-- Structuur van  tabel vorp-pack.users wordt geschreven
...
-- Dumpen data van tabel vorp-pack.users: ~0 rows (ongeveer)
DELETE FROM `users`;
INSERT INTO `users` (`identifier`, `group`, `warnings`, `banned`) VALUES
	('steam:1100001038e0c77', 'admin', 0, 0);

-- Structuur van  tabel vorp-pack.wagons wordt geschreven
...
-- Dumpen data van tabel vorp-pack.wagons: ~0 rows (ongeveer)
DELETE FROM `wagons`;

-- Structuur van  tabel vorp-pack.wagon_water wordt geschreven
...
-- Dumpen data van tabel vorp-pack.wagon_water: ~0 rows (ongeveer)
DELETE FROM `wagon_water`;

-- Structuur van  tabel vorp-pack.whitelist wordt geschreven
...
-- Dumpen data van tabel vorp-pack.whitelist: ~0 rows (ongeveer)
