...
function ready(callback: () => void) {
  setImmediate(() => {
    while (GetResourceState('ghmattimysql') !== 'started') Wait(50);
    callback();
  });
}
...
function query<T = any>(query: Query, parameters?: Params, cb?: Callback<T>): Promise<T | null> | void {
  if (cb) return exports.ghmattimysql.query(...safeArgs(query, parameters, cb));
  return exports.ghmattimysql.query_async(...safeArgs(query, parameters));
}
...
function single<T = Record<string | number, any>>(
  ...
  if (cb) return exports.ghmattimysql.single(...safeArgs(query, parameters, cb));
  return exports.ghmattimysql.single_async(...safeArgs(query, parameters));
}
...
function scalar<T = unknown>(query: Query, parameters?: Params, cb?: Callback<T>): Promise<T | null> | void {
  if (cb) return exports.ghmattimysql.scalar(...safeArgs(query, parameters, cb));
  return exports.ghmattimysql.scalar_async(...safeArgs(query, parameters));
}
...
function update(query: Query, parameters?: Params, cb?: Callback<number>): Promise<number | null> | void {
  if (cb) return exports.ghmattimysql.update(...safeArgs(query, parameters, cb));
  return exports.ghmattimysql.update_async(...safeArgs(query, parameters));
}
...
function insert(query: Query, parameters?: Params, cb?: Callback<number>): Promise<number | null> | void {
  if (cb) return exports.ghmattimysql.insert(...safeArgs(query, parameters, cb));
  return exports.ghmattimysql.insert_async(...safeArgs(query, parameters));
}
...
function prepare<T = unknown>(query: Query, parameters?: Params, cb?: Callback<T>): Promise<T | null> | void {
  if (cb) return exports.ghmattimysql.prepare(...safeArgs(query, parameters, cb));
  return exports.ghmattimysql.prepare_async(...safeArgs(query, parameters));
}
...
function transaction(query: Query, parameters?: Params, cb?: Callback<boolean>): Promise<boolean> | void {
  if (cb) return exports.ghmattimysql.transaction(...safeArgs(query, parameters, cb, true));
  return exports.ghmattimysql.transaction_async(...safeArgs(query, parameters, undefined, true));
}
